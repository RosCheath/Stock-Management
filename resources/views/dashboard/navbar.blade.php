                            ...
                            <div class="nano-content">
                                <ul class="head-list">
                                    ...
                                    <li>
                                        <a href="#" class="media">
                                            ...
                                            <div class="media-left">
                                                <img src="asset_dashboard/img/av2.png" alt="Profile Picture" class="img-circle img-sm">
                                            </div>
                                    ...
                                    <li>
                                        <a href="#" class="media">
                                            <div class="media-left">
                                                <img src="img/av4.png" alt="" class="img-circle img-sm">
                                            </div>
                                            <div class="media-body">
                                                <div class="text-nowrap">Lucy sent you a message</div>
                                    ...
                                    <li>
                                        <a href="#" class="media">
                                            <div class="media-left">
                                                <img src="img/av3.png" alt="" class="img-circle img-sm">
                                            </div>
                                            <div class="media-body">
                                                <div class="text-nowrap">Jackson sent you a message</div>
                                                <small class="text-muted">Yesterday</small>
            ...
            <ul class="nav navbar-top-links pull-right">
                ...
                <li id="dropdown-user" class="dropdown">
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                        <span class="pull-right"> <img class="img-circle img-user media-object" src="" alt=""> </span>

                ...
                <div class="row">
                    <div class="col-lg">
                        <div class="panel">
                            ...
                            <form id="demo-tooltip-validation" action="{{ route('products.store') }}" method="POST" class="form-horizontal">
                                @csrf
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <input type="text" class="form-control" name="quanity" placeholder="Quantity" required value="{{old('quanity')}}">
                                        </div>
                                    </div>
